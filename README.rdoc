...
Install the Moonshine_God plugin:

  script/plugin install git://github.com/railsmachine/moonshine_god.git

Copy the resque.god file from Moonshine_Resque to config/god/resque.god

  mkdir -p config/god
  cp vendor/plugins/moonshine_resque/templates/resque.god config/god/resque.god
  
Edit config/god/resque.god as necessary.
